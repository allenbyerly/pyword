...
"""
text10 = Text(gutenberg.words('adventures-of-sherlock-holmes.txt'), name='Adventures of Sherlock Holmes')
print("text10:", text10.name)
...
#         """
sent10=['To', 'Sherlock', 'Holmes', 'she', 'is', 'always',
        'THE', 'woman', '.']
